...
export declare const electronApi: {
    ...
    actions: {
        ...
        updateInteropState(state: InteropAppState): void;
        updateInteropWindowState(windowId: string, state: Partial<InteropAppState["windows"][string]>): void;
        ...
        updateAltairAppSettingsOnFile(settings: SettingsState): Promise<any>;
    };
};
