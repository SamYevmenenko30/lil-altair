...
exports.ELECTRON_ALLOWED_FORBIDDEN_HEADERS = exports.ALTAIR_WINDOW_ID_HEADER = exports.electronApiKey = exports.ALTAIR_CUSTOM_PROTOCOL = exports.STORE_EVENTS = exports.IPC_EVENT_NAMES = void 0;
exports.IPC_EVENT_NAMES = {
    ...
    RENDERER_SET_INTEROP_ACTIVE_WINDOW_ID_STATE: 'from-renderer:set-interop-active-window-id-state',
    RENDERER_REMOVE_INTEROP_WINDOW_STATE: 'from-renderer:remove-interop-window-state',
};
exports.STORE_EVENTS = {
...
exports.ALTAIR_CUSTOM_PROTOCOL = 'altair';
exports.electronApiKey = 'electronApi';
exports.ALTAIR_WINDOW_ID_HEADER = 'x-altair-window-id';
// https://developer.mozilla.org/en-US/docs/Glossary/Forbidden_header_name
exports.ELECTRON_ALLOWED_FORBIDDEN_HEADERS = [
    'origin',
    'cookie',
    'referer',
].map((_) => _.toLowerCase());
