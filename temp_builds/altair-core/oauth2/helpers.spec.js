...
import { base64EncodeSafe, base64UrlEncode, getCodeChallenge, hex, secureRandomString, sha256, } from './helpers';
describe('oauth2 helpers', () => {
    ...
    describe('sha256', () => {
        it('should hash a string using SHA-256', async () => {
            ...
            const hexed = hex(out);
            expect(hexed).toBe('04aa106279f5977f59f9067fa9712afc4aedc6f5862a8defc34552d8c7206393');
        });
        it('should return expected hash for an empty string', async () => {
            ...
            expect(hexed).toBe('e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855');
        });
    });
