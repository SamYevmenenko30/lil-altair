function parseDotNotationKey(key) {
 ...
 * ```
 */
export function setByDotNotation(obj, path, value, merge = false) {
    ...
    if (typeof path === 'string') {
        return setByDotNotation(obj, path.split('.').map(parseDotNotationKey), value, merge);
    }
