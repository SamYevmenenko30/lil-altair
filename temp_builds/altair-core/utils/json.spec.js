...
describe('json utils', () => {
    describe('parseJson', () => {
        ...
        it('should parse a JSON string with BigInt', () => {
            const obj = parseJson('{"a": 1011111111111111111111111111111111111111111111111111111 }');
            expect(obj.a.toString()).toEqual('1.011111111111111111111111111111111111111111111111111111e+54');
        });
    });
});
