...
exports.ScriptEvaluatorWorkerEngine = void 0;
...
class ScriptEvaluatorWorkerEngine {
    constructor(worker) {
        this.worker = worker;
    }
    start() {
        this.worker.onMessage(async (e) => {
            switch (e.type) {
                case events_1.SCRIPT_INIT_EXECUTE:
                    try {
    ...
    async initExecute(payload) {
        ...
        const res = await new Promise((resolve, reject) => {
            ...
            const context = {
                altair: (0, context_1.getGlobalContext)(clonedMutableData, handlers),
...
exports.ScriptEvaluatorWorkerEngine = ScriptEvaluatorWorkerEngine;
